...
my @include=qw(series.prc  invert.prc exp.prc log.prc power.prc  wrap.prc createtable.prc toseries.prc init.prc expand.prc expandDenominator.prc expandLog.prc expandExp.prc expandPower.prc expandGamma.prc expandFunction.prc parallel.prc partition.frm);
